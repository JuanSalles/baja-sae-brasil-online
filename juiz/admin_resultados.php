...
$resultados = ResultadoQuery::create()->filterByEventoId($evento)->find();
        ...
        <thead>
            <tr style="height: 50px;">
                <th colspan="3" class="sorter-false">
                    ...
                    <span style="font-size: 28px;">Resultados</span>
                </th>
            </tr>
            <tr> 
                <th>Código</th>
...
<?php foreach ($resultados as $r) { ?>
            <tr>
                <td><?= $r->getResultadoId() ?></td>
                <td><?= $r->getNome() ?></td>
                <td><a href='resultado.php?id=<?= $r->getResultadoId() ?>'><span>&nbsp;✏️&nbsp;</span></a></td>
            </tr>
<?php } ?>
        </tbody>
        <tfoot>
            <tr>
                <th colspan="5" style="height: 30px">
                    <input type="button" onclick="location.href='resultado.php?novo=true';" value="Novo Resultado"/>
                </th>
            </tr>
        </tfoot>
    </table>
